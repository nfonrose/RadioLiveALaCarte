 ...
 */
public class ConfigFileMediaCapturePlanningServiceTest {

    @Inject IMediaCapturePlanningService mediaCapturePlanningService;

    @BeforeEach
    public void setUp() {
        Injector injector = Guice.createInjector(new MediaCaptureServiceGuiceModule());
        mediaCapturePlanningService = injector.getInstance(IMediaCapturePlanningService.class);
    }
    ...
    public void testLoadLoadMediaCapturePlanning() throws IOException {
        ...
        List<StreamToCaptureDTO> streams = planning.getStreamsToCapture();
        ...
        StreamToCaptureDTO stream1 = streams.get(0);
        ...
        StreamToCaptureDTO stream2 = streams.get(1);
